...
const TeamMembers = () => {
  ...
  return (
    <section className="bg-white pb-[170px] pt-150  dark:bg-dark-300 max-md:overflow-hidden max-md:pb-25 max-md:pt-20" style={{ backgroundColor: '#E3E4F8' }}>
      <div className="container">
        ...
        <div className="relative z-10">
          ...
          <div className="absolute -top-[550px] left-1/2 -z-10 h-full w-full -translate-x-1/2 bg-[url('/images/hero-gradient.png')]  bg-contain bg-center bg-no-repeat p-[350px] opacity-10 md:hidden"></div>
