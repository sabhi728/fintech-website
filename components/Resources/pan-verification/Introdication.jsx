      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="max-w-[590px] py- max-md:col-span-full md:col-span-6 text-white">
            ...
            "PAN Verification is crucial for businesses in India to ensure that all financial
transactions are compliant with tax regulations. Verifying a PAN (Permanent Account
Number) helps in authenticating the identity of individuals and entities, reducing tax
evasion and enhancing the reliability of financial documentation </p>
          </div>
        </div>
      </div>
    </section>
