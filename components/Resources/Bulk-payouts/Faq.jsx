...
import { FAQbulkpayouts } from '@/data/data'

const Faqbulkpayouts = () => {
  const [activeIndex, setActiveIndex] = useState(null)

  const handleItemClick = (index) => {
    setActiveIndex((prevIndex) => (prevIndex === index ? null : index))
  }
  const generalFaq = FAQbulkpayouts.filter((faq) => faq.type.includes('general'))
  return (
