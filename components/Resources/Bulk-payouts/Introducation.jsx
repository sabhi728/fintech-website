      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="max-w-[590px] py- max-md:col-span-full md:col-span-6 text-white">
            ...
            Bulk payouts are essential for businesses that handle large volumes of
transactions, whether it's disbursing salaries, vendor payments, or customer refunds.
Our solutions provide a robust framework for managing these payments efficiently,
reducing manual errors, and ensuring compliance with financial regulations</p>
          </div>
        </div>
      </div>
    </section>
