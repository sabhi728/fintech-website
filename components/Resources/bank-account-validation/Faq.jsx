...
import { FAQbankaccountvalidation } from '@/data/data'

const Faqbankaccountvalidation = () => {
  const [activeIndex, setActiveIndex] = useState(null)

  const handleItemClick = (index) => {
    setActiveIndex((prevIndex) => (prevIndex === index ? null : index))
  }
  const generalFaq = FAQbankaccountvalidation.filter((faq) => faq.type.includes('general'))
  return (
...
export default Faqbankaccountvalidation
