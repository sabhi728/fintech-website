      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="max-w-[590px] py- max-md:col-span-full md:col-span-6 text-white">
            ...
            Bank Account Validation is essential for businesses across India looking to verify
the authenticity of banking details provided by customers, partners, or employees. By
validating bank account details, companies can prevent fraud, ensure compliance, and
enhance the efficiency of financial transactions. </p>
          </div>
        </div>
      </div>
    </section>
