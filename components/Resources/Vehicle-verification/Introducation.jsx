      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="max-w-[590px] py- max-md:col-span-full md:col-span-6 text-white">
            ...
            Vehicle verification is a critical component for businesses that rely on
transportation and logistics. It involves confirming the authenticity and legal status of
vehicles, which is essential for mitigating risks, enhancing operational safety, and
ensuring compliance with transportation regulations </p>
          </div>
        </div>
      </div>
    </section>
