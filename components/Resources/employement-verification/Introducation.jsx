      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="max-w-[590px] py- max-md:col-span-full md:col-span-6 text-white">
            ...
            In today’s competitive and compliance-driven work environment, verifying the
accuracy of potential employees' credentials is essential. Employment verification helps
businesses across various industries avoid fraudulent practices, ensure compliance with
regulatory standards, and maintain a high standard of employee integrity.</p>
          </div>
        </div>
      </div>
    </section>
