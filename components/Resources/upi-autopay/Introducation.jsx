      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="max-w-[590px] py- max-md:col-span-full md:col-span-6 text-white">
            ...
            UPI Autopay offers a revolutionary way for businesses across India to manage
recurring payments efficiently. Ideal for industries involving regular subscription models
or billing cycles, UPI Autopay facilitates smooth, automated transactions directly linked
to customers’ UPI (Unified Payments Interface) accounts, enhancing payment security
