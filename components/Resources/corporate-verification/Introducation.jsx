      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="max-w-[590px] py- max-md:col-span-full md:col-span-6 text-white">
            ...
            "Corporate verification is crucial for any business that engages with other corporate
entities. This process ensures that companies are legally registered, operationally
legitimate, and compliant with industry regulations, thus safeguarding your business
against potential risks associated with corporate fraud and legal violations. </p>
          </div>
        </div>
      </div>
    </section>
