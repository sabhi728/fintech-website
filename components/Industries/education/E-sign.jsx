      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Handling numerous documents such as enrollment forms, financial aid agreements, and faculty contracts digitally and securely is essential but often inefficient.
            <br/>
            <br/>
            <b>Solution:</b> E-Sign facilitates the digital signing of educational documents in a secure, legally compliant manner, expediting paperwork and administrative processes.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Paperwork: Minimizes the need for physical document handling and storage.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Faster Administrative Processes: Accelerates the signing and processing of critical documents, enhancing overall efficiency.</span>
              </li>
