      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing tuition fee collection and other financial transactions can be complex, often involving multiple payment methods and financial aid arrangements.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services offer a robust solution for handling all types of financial transactions, from tuition fee payments to donations, integrated into one seamless system.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Financial Transactions: Simplifies the management of tuition and other fees, improving cash flow.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Increased Convenience for Students and Parents: Offers multiple payment options, enhancing accessibility and satisfaction.</span>
              </li>
