      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Evaluating the financial stability of potential corporate donors or institutional partners is crucial for managing financial risks and setting partnership terms.
            </p>
            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Access to comprehensive credit reports from reputable credit bureaus helps educational institutions evaluate the financial reliability of businesses and individuals.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Informed Financial Decisions: Facilitates better negotiation of partnership terms based on financial health.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Risk Management: Helps mitigate potential financial risks associated with new partnerships.</span>
              </li>
