        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Establishing and verifying partnerships with
              educational service providers, vendors, and other institutions can
              be time-consuming and fraught with compliance risks.
              <br />
              <br />
              <b>Solution:</b> B2B Onboarding simplifies the verification of new
              educational partners and vendors, ensuring compliance and
              operational readiness before forming collaborations.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Streamlined Partnership Management: Enhances the efficiency of
                  integrating new service providers and vendors.
                </span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Compliance Assurance: Ensures all partnerships adhere to
                  educational standards and regulatory requirements.
                </span>
              </li>
            </ul>
          </div>
