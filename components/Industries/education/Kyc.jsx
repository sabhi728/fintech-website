      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Educational institutions often encounter challenges in verifying student identities and managing large volumes of student enrollment data securely and efficiently.
            </p>

            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Our KYC and Onboarding services streamline the student enrollment process by automating identity verification and data collection, ensuring accuracy and compliance with educational standards.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Enrollment Processes: Reduces administrative burdens and expedites the registration process.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Data Security: Ensures that student data is handled securely, protecting privacy and complying with regulations.</span>
              </li>
