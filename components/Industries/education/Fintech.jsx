        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Integrating financial operations with existing educational systems can be technically challenging and limit the capability to offer more customized student services.
              <br />
              <br />
              <b>Solution:</b> Our Fintech APIs enable seamless integration of financial services into educational systems, enhancing functionalities such as scholarship management, fee waivers, and campus card services.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              ...
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white ">Customized Financial Services: Allows institutions to offer tailored financial solutions to students.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white ">Enhanced System Integration: Reduces operational silos, facilitating smoother inter-departmental functions.</span>
              </li>
            </ul>
          </div>
        </div>
