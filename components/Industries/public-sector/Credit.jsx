      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Evaluating the financial health of contracting parties and beneficiaries is crucial for risk management in public sector finance.
            </p>
            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Access to comprehensive credit reports from reputable credit bureaus provides government entities with insights into the financial stability of businesses and individuals.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Risk Management: Facilitates informed decision-making in public sector contracts and grants.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Financial Oversight: Provides a clear assessment of financial risks associated with public spending.</span>
              </li>
