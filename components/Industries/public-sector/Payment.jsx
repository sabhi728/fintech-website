      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing financial transactions, such as tax collections and disbursements of benefits, can be complex and prone to delays.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services offer robust solutions for handling all types of financial transactions securely and efficiently.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Financial Transactions: Simplifies the management of tax collections, fines, and disbursements, enhancing financial management.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Increased Financial Transparency: Provides clear, traceable records of all transactions, bolstering public trust.</span>
              </li>
