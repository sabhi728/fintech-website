        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Establishing and verifying collaborations with
              private sector partners and suppliers can be time-consuming and
              fraught with compliance risks.
              <br />
              <br />
              <b>Solution:</b> B2B Onboarding simplifies the verification of
              business entities, ensuring that all collaborations meet regulatory
            ...
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  ...
                  incorporating new suppliers or partners.
                </span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Compliance Assurance: Guarantees that all business collaborations
                  adhere to stringent government standards.
                </span>
              </li>
            </ul>
          </div>
