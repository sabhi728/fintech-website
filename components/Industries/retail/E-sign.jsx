      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Handling paperwork for contracts, supplier agreements, and customer consents can be cumbersome and time-consuming.
            <br/>
            <br/>
            <b>Solution:</b> E-Sign allows digital signing of all retail-related documents in a secure, legally compliant manner, speeding up transactions and agreements.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Paperwork: Minimizes the need for physical storage and handling.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Faster Transactions: Accelerates the contract and agreement processes, improving supply chain efficiency.</span>
              </li>
