      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Assessing the creditworthiness of new business customers or partners is crucial for managing financial risks.
            </p>
            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Access comprehensive credit reports from reputable credit bureaus to evaluate the financial stability of B2B clients.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Risk Management: Reduces the likelihood of bad debt in B2B transactions.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Informed Decision Making: Provides insights into the financial behavior of potential business customers.</span>
              </li>
