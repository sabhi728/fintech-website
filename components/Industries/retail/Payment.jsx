      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing multiple payment channels efficiently and securely is crucial for retailers to ensure customer trust and operational efficiency.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services facilitate a variety of payment methods including UPI, credit/debit cards, and mobile payments, integrated into one seamless system.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Payments: Simplifies the payment process for both customers and staff.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Cash Flow: Ensures timely and secure collections and disbursements.</span>
              </li>
