        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Verifying credentials of new suppliers or business
              partners is essential but can be time-consuming and delay
              operations.
              <br />
              <br />
              <b>Solution:</b> B2B Onboarding facilitates the quick verification of
              businesses, ensuring compliance and legitimacy before forming
              partnerships.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Secure Supplier Relationships: Enhances trust and security in
                  B2B transactions.
                </span>
              </li>
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Efficient Onboarding: Speeds up the process of adding new
