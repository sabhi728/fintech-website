      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Assessing the creditworthiness of new corporate clients and managing credit risks is crucial for maintaining financial stability.
            </p>
            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Access to comprehensive credit reports from major credit bureaus provides insights into the financial stability of business customers.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Informed Credit Decisions: Facilitates better negotiation of payment terms and credit limits.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Financial Risks: Helps mitigate potential losses from non-paying clients.</span>
              </li>
