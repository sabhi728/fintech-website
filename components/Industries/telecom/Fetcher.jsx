        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Accessing and verifying customer information for service upgrades, contract renewals, or compliance audits can be cumbersome.
              <br />
              <br />
              <b>Solution:</b> Fetcher provides rapid access to detailed customer profiles, enabling telecom operators to quickly retrieve and verify necessary information.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              ...
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white "> Operational Efficiency: Streamlines customer service processes, improving response times and satisfaction.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white "> Accurate Data Handling: Ensures that all customer data is up-to-date and accurately reflected in the system for billing and regulatory purposes.</span>
              </li>
            </ul>
          </div>
        </div>
