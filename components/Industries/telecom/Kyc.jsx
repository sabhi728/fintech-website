      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Telecom companies often struggle with efficiently verifying customer identities during new account setups, which can lead to delays and potential compliance issues.
            </p>

            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Our KYC and Onboarding services automate the identity verification process using digital technologies, speeding up account activations and ensuring adherence to regulatory standards.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Activation Time: Enhances customer onboarding experience by significantly reducing the time needed to activate new services.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Compliance: Meets strict regulatory requirements for identity verification, minimizing the risk of penalties.</span>
              </li>
