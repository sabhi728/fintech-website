      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing the collection of recurring payments for services and ensuring efficient processing of payments can be complex due to the high volume of transactions.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services facilitate streamlined solutions for managing all types of transactions, from monthly service fees to one-time payments, integrated into one seamless system.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Improved Cash Flow: Ensures timely collections and better cash flow management.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Customer Convenience: Offers multiple payment options, enhancing customer satisfaction and retention.</span>
              </li>
