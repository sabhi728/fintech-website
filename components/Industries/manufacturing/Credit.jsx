      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Assessing the financial stability of suppliers and customers is crucial for managing credit risks and setting payment terms.
            </p>
            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Access comprehensive credit reports from reputable credit bureaus to evaluate the financial reliability of business partners.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Informed Credit Decisions: Facilitates better negotiation of payment terms and credit limits based on the financial health of suppliers and customers.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Risk Management: Reduces potential financial risks associated with extending credit to business partners.</span>
              </li>
