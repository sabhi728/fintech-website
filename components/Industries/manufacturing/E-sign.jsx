      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing contracts and agreements with numerous suppliers and clients often involves extensive paperwork and delays in contract execution.
            <br/>
            <br/>
            <b>Solution:</b> E-Sign enables digital signing of contracts and agreements in a secure, legally compliant manner, expediting these processes significantly.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium ">Faster Contract Execution: Speeds up the contract signing process, enhancing supply chain agility.</span>
              </li>
