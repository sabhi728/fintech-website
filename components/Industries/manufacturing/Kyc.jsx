      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Verifying the identity of new suppliers and clients in different geographic locations can be time-consuming and fraught with compliance risks.
            </p>

            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Our KYC and Onboarding services streamline this process, enabling manufacturers to quickly and securely verify identities using digital technologies, ensuring compliance with global trade regulations.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Security and Compliance: Mitigates the risk of fraud and ensures adherence to international trade regulations.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Faster Supplier and Client Integration: Accelerates the onboarding process, reducing downtime and enhancing productivity.</span>
              </li>
