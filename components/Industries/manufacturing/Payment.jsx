      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing diverse payment channels and ensuring timely transactions across the supply chain can be complex and inefficient.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services offer streamlined solutions for handling all types of financial transactions, from vendor payments to customer collections, integrated into one seamless system.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Financial Transactions: Simplifies the management of diverse payment streams and enhances cash flow.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Transaction Costs: Lowers costs associated with financial transactions by optimizing payment processes.</span>
              </li>
