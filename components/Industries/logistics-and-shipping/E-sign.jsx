      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Handling numerous documents such as contracts, bills of lading, and delivery receipts digitally and securely is essential but often inefficient.
            <br/>
            <br/>
            <b>Solution:</b> E-Sign enables digital signing of all logistics-related documents in a secure, legally compliant manner, expediting documentation processes significantly.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium ">Faster Documentation Processes: Accelerates the signing and processing of critical documents, enhancing supply chain velocity.</span>
              </li>
