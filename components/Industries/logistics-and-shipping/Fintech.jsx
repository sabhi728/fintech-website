        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Integrating financial operations with existing logistics management systems can be technically challenging and limit scalability.
              <br />
              <br />
              <b>Solution:</b> Our Fintech APIs allow for seamless integration of financial services into existing logistics systems, enhancing functionalities such as automated billing, cost management, and financial reporting.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white ">Scalability and Flexibility: Supports growth and adaptation to changing market conditions without disrupting core operations.</span>
              </li>
            </ul>
          </div>
        </div>
