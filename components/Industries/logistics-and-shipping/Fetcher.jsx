        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Accessing comprehensive and accurate information about shipment histories, customer interactions, and partner reliability quickly is often cumbersome.
              <br />
              <br />
              <b>Solution:</b> Fetcher retrieves detailed logistical data using minimal inputs, providing logistics companies with the necessary information to make informed decisions.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              ...
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white "> Improved Decision Making: Enables better strategic planning and risk assessment.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white "> Operational Efficiency: Reduces the time and resources spent on information gathering.</span>
              </li>
            </ul>
          </div>
        </div>
