      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Verifying the identity of new customers and partners across different regions can be time-consuming and prone to errors, impacting business relationships and compliance.
            </p>

            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Our KYC and Onboarding services automate and secure the verification process, enabling logistics companies to efficiently validate identities using digital technologies, ensuring compliance with global trade regulations.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Security and Compliance: Reduces the risk of fraud and ensures compliance with international trade laws.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Faster Onboarding of New Partners: Accelerates the integration process, reducing downtime and enhancing global operations.</span>
              </li>
