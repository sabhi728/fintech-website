      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Evaluating the creditworthiness of corporate clients and partners is essential but challenging, impacting policy pricing and terms.
            </p>
            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Access to comprehensive credit reports from reputable credit bureaus provides insights into the financial stability of corporate clients.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Informed Risk Management: Enhances decision-making for underwriting and policy terms.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Financial Exposure: Helps mitigate potential risks associated with high-value corporate policies.</span>
              </li>
