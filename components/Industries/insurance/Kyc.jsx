      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Insurance companies often struggle with lengthy and complex customer onboarding processes, which can lead to customer dissatisfaction and drop-offs.
            </p>

            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Our KYC and Onboarding services streamline customer verification using digital technologies to swiftly validate identities, significantly speeding up the onboarding process while ensuring compliance with regulatory standards.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Customer Experience: Reduces the time taken for policy issuance.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Regulatory Compliance: Ensures adherence to anti-money laundering (AML) and other regulations.</span>
              </li>
