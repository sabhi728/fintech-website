      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing premium collections, claim disbursements, and partner payments efficiently is crucial but often challenging due to disparate systems.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services offer streamlined solutions for managing all financial transactions within the insurance lifecycle, from premium collections to claims disbursements.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Operational Efficiency: Simplifies and accelerates transaction processes.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Improved Cash Flow Management: Enhances liquidity management with timely collections and disbursements.</span>
              </li>
