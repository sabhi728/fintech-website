      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> The insurance sector often deals with a high volume of documents requiring secure and verifiable signatures, which can delay processing.
            <br/>
            <br/>
            <b>Solution:</b> E-Sign enables digital signing of insurance documents in a secure, legally compliant manner, expediting policy agreements, claims processing, and compliance documentation.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Turnaround Times: Decreases processing time for claims and new policies.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
