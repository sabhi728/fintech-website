      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Healthcare providers often handle a high volume of documents that require secure and verifiable signatures, such as patient consent forms and treatment agreements.
            <br/>
            <br/>
            <b>Solution:</b> E-Sign facilitates the digital signing of healthcare documents in a secure, legally compliant manner, expediting paperwork and compliance processes.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Improved Compliance: Ensures that all documents are signed in accordance with healthcare regulations.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Patient Experience: Speeds up document processing, reducing patient wait times and improving service delivery.</span>
              </li>
