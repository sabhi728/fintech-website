      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing patient billing and insurance claims can be cumbersome, leading to delays in payments and financial discrepancies.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services offer integrated solutions for handling patient payments, insurance billing, and collections efficiently.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Billing Processes: Simplifies the management of patient accounts and improves cash flow.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Administrative Costs: Automates billing and collection processes, decreasing the cost of managing finances.</span>
              </li>
