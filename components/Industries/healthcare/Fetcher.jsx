        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Healthcare providers need quick access to patient histories and records for informed decision-making and treatment planning.
              <br />
              <br />
              <b>Solution:</b> Fetcher retrieves comprehensive patient information using minimal data inputs, providing healthcare professionals with quick access to detailed medical histories and previous treatment records.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              ...
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white "> Informed Patient Care: Supports better clinical decision-making with comprehensive access to patient histories.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white "> Efficiency in Record Management: Reduces the administrative burden of manual data retrieval, freeing up resources for patient care.</span>
              </li>
            </ul>
          </div>
        </div>
