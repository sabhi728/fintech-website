      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Healthcare providers often deal with patient identity verification, which can be time-consuming and prone to errors, affecting patient intake and billing processes.
            </p>

            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Our KYC and Onboarding services automate patient verification using digital technologies, streamlining the check-in process and ensuring that patient data is accurate and secure.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Patient Data Accuracy: Reduces errors in patient data, ensuring effective treatment and billing.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Improved Patient Onboarding Experience: Speeds up registration processes, reducing wait times and improving patient satisfaction.</span>
              </li>
