      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Real estate transactions involve significant compliance requirements, including rigorous verification of client identities and financial backgrounds.
            </p>

            <p className="mb-11 max-md:mb-6 ">
            <b>Solution:</b> Our KYC and Onboarding services automate the verification process, enabling real estate agencies to efficiently validate client identities and financial information, ensuring compliance with regulatory standards.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Security and Compliance: Reduces the risk of fraud in high-value transactions and ensures adherence to anti-money laundering (AML) regulations.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Client Onboarding: Accelerates the property buying and leasing process, improving client satisfaction.</span>
              </li>
