        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              ...
              construction firms, property management services, and other
              stakeholders can be time-consuming and fraught with compliance
              risks.
              <br />
              <br />
              <b>Solution:</b> B2B Onboarding streamlines the verification process
              for new business partners, ensuring compliance and operational
              readiness before forming collaborations.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Streamlined Partner Management: Enhances the efficiency of
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Compliance Assurance: Guarantees that all business partnerships
