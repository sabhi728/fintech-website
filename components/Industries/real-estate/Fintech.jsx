        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Integrating financial operations with existing real estate management systems can be technically challenging and hinder operational efficiency.
              <br />
              <br />
              <b>Solution:</b> Our Fintech APIs allow for seamless integration of financial services into real estate platforms, enhancing functionalities such as rental collections, escrow management, and financial reporting.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              ...
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white ">Enhanced Integration: Facilitates smooth financial operations without the need for major system overhauls.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white ">Operational Efficiency: Reduces manual effort and automates financial transactions, freeing up resources for core real estate activities.</span>
              </li>
            </ul>
          </div>
        </div>
