      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing diverse payment channels and ensuring timely transactions in real estate can be complex and error-prone.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services offer robust solutions for handling all types of financial transactions, from down payments to recurring lease collections, integrated into one seamless system.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Financial Transactions: Simplifies the management of real estate payments and enhances cash flow.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Increased Financial Transparency: Provides clear, traceable records of all transactions, bolstering trust among clients.</span>
              </li>
