      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Real estate deals involve numerous documents that require secure and verifiable signatures, which can delay transactions.
            <br/>
            <br/>
            <b>Solution:</b> E-Sign enables digital signing of contracts, lease agreements, and sales documents in a secure, legally compliant manner, expediting the documentation process.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Reduced Paperwork and Turnaround Times: Decreases the time needed for document processing and approvals, enhancing operational efficiency.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Enhanced Security and Compliance: Ensures that all signed documents are legally binding and secure.</span>
              </li>
