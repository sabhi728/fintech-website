        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> HR needs quick and reliable access to a candidate's history for background checks.
              <br />
              <br />
              <b>Solution:</b> Fetcher retrieves detailed personal and professional information with minimal input, providing a holistic view of candidates.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              ...
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white "> Comprehensive Background Checks: Enhance the quality of hires with detailed background data.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white "> Efficiency: Save time and resources in the recruitment process</span>
              </li>
            </ul>
          </div>
        </div>
