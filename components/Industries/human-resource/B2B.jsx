        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Verifying credentials of vendors and contractors is
              time-consuming and necessary to meet compliance standards.
              <br />
              <br />
              <b>Solution:</b> B2B Onboarding streamlines the verification of
              businesses and contractors, ensuring all necessary documentation and
              credentials are verified quickly.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Risk Mitigation: Protect against fraud and ensure compliance
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Efficiency in Partnerships: Quicker onboarding of new vendors and
                  contractors reduces downtime.
                </span>
              </li>
            </ul>
          </div>
