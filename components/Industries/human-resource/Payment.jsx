      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> Managing payroll and reimbursements is cumbersome and error-prone.
            <br/>
            <br/>
            <b>Solution:</b> Our Payment and Collection services facilitate streamlined payroll processing and efficient handling of employee reimbursements.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Automated Payroll Systems: Reduce errors and administrative costs.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Timely Payments: Ensure employees are paid accurately and on time, boosting satisfaction and retention.</span>
              </li>
