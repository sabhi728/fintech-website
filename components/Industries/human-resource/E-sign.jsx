      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:</b> The need for signatures on HR documents often delays processes.
            <br/>
            <br/>
            <b>Solution:</b> E-Sign enables digital signing of employment contracts, policies, and other HR documents legally and securely.
            </p>
            ...
            <h5 className=""><b>Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Expedite Document Processes: Reduce turnaround times for document approvals.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Legal Assurance: Comply with legal standards for digital signatures, ensuring documents are court-admissible.</span>
              </li>
