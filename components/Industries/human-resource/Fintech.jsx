        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Problem:</b> Integrating financial operations with HR systems can be technically challenging and resource-intensive.
              <br />
              <br />
              <b>Solution:</b> Our Fintech APIs provide seamless integration of financial services into HR systems, enhancing functionality without complex system overhauls.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              ...
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white ">Enhanced Financial Management: Streamline benefits, pensions, and other financial aspects directly through HR platforms.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white ">Scalability: Easily adjust functionalities as your organization grows and changes.</span>
              </li>
            </ul>
          </div>
        </div>
