      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Application:</b> Access in-depth credit reports from major RBI-regulated bureaus for comprehensive risk assessment and monitoring. Tailor these services for individual or corporate credit evaluations.
            </p>
            ...
            <h5 className=""><b>Specific Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Informed Decision Making: Base lending decisions on accurate, comprehensive credit data that spans multiple credit bureaus.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Risk Management: Effectively manage credit risk with continuous monitoring and updated credit reports.</span>
              </li>
