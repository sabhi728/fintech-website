        ...
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <p className="mb-11 max-md:mb-6 text-white">
              <b>Application:</b> Facilitate the verification of business
              entities during B2B client onboarding, checking corporate documents
              like GSTIN, CIN, and Udyog Aadhaar to ensure legitimacy and
              compliance.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
              <h5 className="text-white">
                <b>Specific Benefits:</b>
              </h5>
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Trust and Security: Establish trusted business relationships by
                  ensuring all partners and suppliers are verified and compliant.
                </span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  Efficiency in Partnership Development: Speed up the process of
                  adding new business clients or partners by streamlining the
