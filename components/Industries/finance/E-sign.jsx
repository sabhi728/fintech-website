      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Application:</b> Apply our E-Sign technology for digital signing of contracts, loan agreements, and other legal documentation, fully compliant with IT Act regulations, using Aadhaar OTP and facial recognition technology.
            </p>
            ...
            <h5 className=""><b>Specific Benefits:</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Operational Agility: Conduct remote transactions securely without the need for physical presence, which is crucial in today’s digital age.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">Legal Compliance and Security: Maintain high security and legal standards, ensuring that digital signatures are legally binding and secure.</span>
              </li>
