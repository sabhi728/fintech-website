      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <b>Problem:</b> Accessing comprehensive information on vehicle history, customer credit, and other details can be time-consuming and inaccurate.
            <br/>
            <br/>
            <b>Solution:</b>Fetcher retrieves detailed, reliable information quickly using minimal data inputs, providing automotive businesses with the insights needed for informed decision-making.
            </p>
            ...
            <h5 className="text-white"><b>Benefits:-</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white "> Improved Sales Process:- Enables better customer qualification and personalized sales strategies</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white "> Risk Reduction:- Provides accurate vehicle and customer history to mitigate potential issues</span>
              </li>
