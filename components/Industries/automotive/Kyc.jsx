      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:-</b> Automotive dealers often deal with extensive paperwork and lengthy processes when onboarding new customers or partners.
            <br/>
            <br/>
            <b>Solution:-</b> Our KYC and Onboarding services simplify this process through digital verification of identities and credentials, speeding up transactions and ensuring regulatory compliance
            </p>
            ...
            <h5 className=""><b>Benefits:-</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">Streamlined Customer Onboarding:- Reduces the time from customer interest to ownership.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium "> Enhanced Compliance:- Meets strict regulatory standards required in automotive sales and financing.</span>
              </li>
