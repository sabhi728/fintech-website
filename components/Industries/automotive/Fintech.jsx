      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <br/> <p className="mb-11 max-md:mb-6 text-white">
            <b>Problem:</b>  Integrating financial operations with sales, service, and inventory systems can be complex and hinder operational efficiency.
            <br/>
            <br/>
            <b>Solution:</b> Our Fintech APIs allow for seamless integration of financial services into existing automotive systems, enhancing functionalities such as inventory management, sales tracking, and customer loyalty programs.
</p>
            ...
            <h5 className="text-white"><b>Benefits:-</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white ">  Operational Efficiency:- Reduces manual effort and automates financial transactions.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white ">  Customized Customer Offerings: Facilitates dynamic pricing and financing options tailored to customer needs.</span>
              </li>
