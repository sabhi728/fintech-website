      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:-</b>  Assessing the financial stability of potential business customers and partners is crucial for managing credit risks, especially in dealership financing.

            <br/>
            <br/>
            <b>Solution:-</b>  Access to comprehensive credit reports from major credit bureaus provides insights into the financial stability of businesses and individuals
            ...
            <h5 className=""><b>Benefits:-</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">  nformed Credit Decisions:- Enhances decision-making for extending credit for vehicle purchases.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">   Risk Management:- Helps mitigate potential financial risks associated with high-value transactions</span>
              </li>
