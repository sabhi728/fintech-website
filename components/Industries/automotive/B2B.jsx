      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <b>Problem:</b> Establishing and verifying new partnerships with suppliers and service providers can be time-consuming and fraught with compliance risks.
            <br/>
            <br/>
            <b>Solution:</b>  B2B Onboarding streamlines the verification process for new business partners, ensuring compliance and legitimacy before forming partnerships.
</p>
            ...
            <h5 className="text-white"><b>Benefits:-</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium text-white ">   Streamlined Supply Chain Management: Enhances the efficiency of adding new suppliers or partners</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium text-white ">  Customized Customer Offerings: Compliance Assurance: Ensures all business partners adhere to industry standards and regulations</span>
              </li>
