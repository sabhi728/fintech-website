      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:-</b>  The automotive sales process often requires multiple contracts and documentation, which can delay transactions.

            <br/>
            <br/>
            <b>Solution:-</b>  E-Sign enables digital signing of sales agreements, financing contracts, and service agreements in a secure, legally compliant manner.
            ...
            <h5 className=""><b>Benefits:-</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium ">  Reduced Paperwork:- Minimizes the need for physical documents, speeding up sales and service processes.</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">   Legal Compliance:- Ensures that all signed documents are legally binding and secure.</span>
              </li>
