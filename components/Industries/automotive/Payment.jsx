      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <b>Problem:-</b> Managing diverse payment options and financing agreements efficiently is crucial but often challenging due to disparate systems.
            <br/>
            <br/>
            <b>Solution:-</b>  Our Payment and Collection services offer a unified solution for handling all types of payments and collections, from upfront payments to installment collections
            </p>
            ...
            <h5 className=""><b>Benefits:-</b></h5>
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium "> Streamlined Financial Transactions:- Simplifies the management of diverse payment streams</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium ">  Enhanced Customer Experience: Provides flexible payment options, improving customer satisfaction.</span>
              </li>
