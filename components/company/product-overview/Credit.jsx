...
import visionImage2Light from '@/public/images/Credit.png'
import visionImage2Dark from '@/public/images/Credit.png'
    ...
    <section className="relative mt-50 overflow-hidden bg-[#E3E4F8] pb-[100px] pt-[100px] dark:mt- dark:bg-dark max-md:mt- max-md:pb-10 max-md:pt-[10px] dark:max-md:mt-">
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            <h2 className="section-tagline ">Credit Bureau</h2>
            <br />
            <p className="mb-11 max-md:mb-6">
              <b>Overview:</b> Access detailed credit reports and scores from leading credit bureaus with our integrated solution, designed to support lending decisions and financial analysis.
            </p>
             <h3 className=""><b>Features:</b></h3>
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium">Real-time credit scoring</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium">Integration with major credit bureaus</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium">Customizable credit decision models</span>
              </li>
            </ul>
             <h3 className=""><b>Benefits:</b></h3>
              ...
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium">Improves risk assessment capabilities</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                    ...
                    <span className="font-jakarta_sans font-medium">Supports data-driven lending decisions</span>
                  </li>
                  <li className="flex items-center gap-x-2">
                    <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                      <FontAwesomeIcon
                    ...
                    <span className="font-jakarta_sans font-medium">Enhances customer profiling for targeted offerings</span>
                  </li>
                </ul>
              </div>
