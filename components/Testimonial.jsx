...
const Testimonial = () => {
  return (
    <section className="relative bg-[#0A003D]  pb-150 pt-150 dark:bg-dark-300 max-md:py-20">
      ...
      <div className="container relative">
        <div className="mx-auto mb-16 max-w-[550px] text-center">
          <p className="section-tagline text-white">Testimonials</p>
          <h2 className='text-white'> What our customer&rsquo;s say about our company </h2>
        </div>
        <div className="relative z-10">
          ...
          <div className=" mb-12 flex flex-wrap justify-center gap-6 gap-y-8 max-md:flex-col">
            {TestimonialData.slice(0, 2).map((testimonial) => (
              <div
