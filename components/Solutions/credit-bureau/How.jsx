            ...
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  <b>Data Access:</b> Gather credit data using identifiers such as name, address, mobile number, and ID for individuals, and similar identifiers for corporations.
                </span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  <b>Report Compilation:</b> Compile comprehensive reports that reflect detailed credit histories, including data from MFI, retail, and corporate sectors.
                </span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  <b>Delivery:</b> Receive these reports in a format that integrates seamlessly into your decision-making processes, ensuring you have the information when you need it.
                </span>
              </li>
            </ul>
          </div>
