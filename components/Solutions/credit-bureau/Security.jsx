      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-">
         <div className="max-w-[1000px]">
              ...
              Adherence to the highest standards of data security and regulatory
compliance is at the heart of our Credit Bureau services. All data is processed and
handled with the utmost integrity, ensuring compliance with RBI guidelines and
protecting the privacy of individuals and entities involved
            </p>
          ...
          <br/>
              <p className='text-white'>
              We employ robust encryption and secure handling practices to
              maintain data integrity and confidentiality.</p>
          </div>
        </div>
      </div>
    </section>
