...
<motion.div
  ...
  />
          ...
          <div className="max-md:order-1 lg:-mt-15">
            ...
            <h2 className="mb-8 max-lg:mb-4 text-white">Utilities APIs</h2>
            ...
            <ul>
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  <b>Overview:-</b>  Streamline daily operations with essential services like Electricity Bill API, RC Verification, and Stolen Vehicle Verification.
                </span>
              </li>
              <li className="flex pt-[10px] items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  <b>Email Verification and Tenant Registration: :-</b>  Enhance your customer onboarding process in rental and real estate sectors with reliable checks
                </span>
              </li>
            </ul>
          </div>
