...
const Collection = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#0A003D] pb-150 pt-[100px] dark:bg-dark-300 max-lg:pb-100 max-lg:pt-20 lg:pb-15">
...
<motion.div
  ...
  />
          ...
          <div className="max-md:order-1 lg:-mt-15">
            ...
            <h2 className="mb-8 max-lg:mb-4 text-white">Collecion Solution</h2>
            ...
            <ul>
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  <b>AutoPay :-</b> Automate recurring payments for subscriptions and services, enhancing customer retention and simplifying revenue collection.
                </span>
              </li>
              <li className="flex pt-[10px] items-center gap-x-2">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  <b>Virtual Accounts :-</b> Use virtual accounts to manage multiple payment streams and facilitate easier reconciliation.
                </span>
              </li>
              <li className="flex pt-[10px] items-center gap-x-2">
                <span className="shadow-icon item-center relative flex h-7 w-16 justify-center rounded-full bg-white dark:bg-dark-200">
                ...
                <span className="font-jakarta_sans font-medium text-white">
                  <b>NACH :-</b> Automate recurring payments for installments, ensuring timely collection and simplifying revenue collection.
                </span>
              </li>
            </ul>
          </div>
