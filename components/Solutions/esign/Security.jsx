      ...
      <div className="container relative ">
        ...
        <div className="grid grid-cols-">
         <div className="max-w-[1000px]">
              ...
              Our E-Sign solutions are designed with stringent security measures and
comply with all relevant legal standards, including provisions under the IT Act, ensuring
that every electronic signature is as legally binding as its handwritten counterpart
            </p>
