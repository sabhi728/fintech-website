...
const CareerList = () => {
  ...
  return (
    <section className="relative bg-[#0A003D] pb-150 max-md:overflow-hidden"  style={{paddingTop:'50px' }}>
      ...
      <div className="container relative">
        ...
        <div className="mb-14 text-center">
          <p className="section-tagline text-white">Open Positions</p>
          <h2 className='text-white'>Become part of the dream team</h2>
        </div>
