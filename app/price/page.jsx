...
const Price = () => {
  ...
  return (
    <>
      <section className="relative mb-150  overflow-hidden bg-white pt-[240px] dark:bg-dark-300 max-lg:pt-150 max-md:mb-25">
        <div className="container ">
          <motion.div
            className="relative z-10 mx-auto mb-12 max-w-[948px] text-center"
            ref={ref}
            initial="initial"
